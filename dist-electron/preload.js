...
contextBridge.exposeInMainWorld("electron", {
  ...
  // Transcription
  transcribeAudio: (filePath, apiKey, options) => ipcRenderer.invoke("transcribe-audio", filePath, apiKey, options),
  generateSummary: (transcript, templatePrompt, apiKey) => ipcRenderer.invoke("generate-summary", transcript, templatePrompt, apiKey),
  saveTranscript: (content, format, fileName) => ipcRenderer.invoke("save-transcript", content, format, fileName),
